/*
5. Programming Project 6, pg. 804. Use an inner class PQElement to create objects
that bundles the items and their priorities together. You should use an ArrayList to store
these objects.
*/
